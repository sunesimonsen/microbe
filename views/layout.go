		...
		Nav(
			...
			Div(
				...
				Button(
					...
					Attr("popovertarget", "color-scheme-menu"),
					Attr("aria-controls", "color-scheme-menu"),
					Attr("aria-haspopup", "menu"),
					Class("ghost icon"),
					Title("Color scheme"),
					Span(Class("color-scheme-icon color-scheme-icon-system"), Attr("aria-hidden", "true"), icons.CircleHalfFillIcon()),
					Span(Class("color-scheme-icon color-scheme-icon-light"), Attr("aria-hidden", "true"), icons.SunIcon()),
					Span(Class("color-scheme-icon color-scheme-icon-dark"), Attr("aria-hidden", "true"), icons.MoonIcon()),
				),
				Ul(
					...
					Attr("popover", "auto"),
					Attr("role", "menu"),
					Attr("aria-label", "Color scheme"),
					Li(Button(Type("button"), Attr("data-color-scheme", "system"), Attr("role", "menuitemradio"), Aria("checked", "true"),
						Span(Attr("aria-hidden", "true"), icons.CircleHalfFillIcon()), Text("System"))),
					Li(Button(Type("button"), Attr("data-color-scheme", "light"), Attr("role", "menuitemradio"), Aria("checked", "false"),
						Span(Attr("aria-hidden", "true"), icons.SunIcon()), Text("Light"))),
					Li(Button(Type("button"), Attr("data-color-scheme", "dark"), Attr("role", "menuitemradio"), Aria("checked", "false"),
